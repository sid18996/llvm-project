...
for.cond:                                         ; preds = %for.inc18, %entry
  %n.0 = phi i32 [ 30, %entry ], [ %n.1, %for.inc18 ]
...
for.cond1:                                        ; preds = %if.end, %for.body
  %n.1 = phi i32 [ %n.0, %for.body ], [ %spec.select, %if.end ]
  %j.0 = phi i32 [ %add, %for.body ], [ %inc, %if.end ]
  %cmp2 = icmp slt i32 %j.0, %n.1
...
if.end:                                           ; preds = %if.then, %for.body3
  %cmp15 = icmp slt i32 %n.1, 30
  %spec.select = select i1 %cmp15, i32 30, i32 %n.1

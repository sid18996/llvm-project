...
if.then:                                          ; preds = %for.body
  ...
  %call8 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* nonnull dereferenceable(8) %call7, i32 %j.0)
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %i.1 = phi i32 [ %j.0, %if.then ], [ %i.0, %for.body ]
  br label %for.inc
...
entry:
  ...
  call void @_Z18printMaxActivitiesPiS_i(i32* %arraydecay, i32* %arraydecay1, i32 6)
  ret i32 0
}

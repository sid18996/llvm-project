; ModuleID = 'greedy-algo1.cpp'
source_filename = "greedy-algo1.cpp"
...
@.str = private unnamed_addr constant [35 x i8] c"Following activities are selected \00", align 1
@.str.1 = private unnamed_addr constant [2 x i8] c" \00", align 1
@__const.main.s = private unnamed_addr constant [6 x i32] [i32 1, i32 3, i32 0, i32 5, i32 8, i32 5], align 16
@__const.main.f = private unnamed_addr constant [6 x i32] [i32 2, i32 4, i32 6, i32 7, i32 9, i32 9], align 16
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_greedy_algo1.cpp, i8* null }]
...
define dso_local void @_Z18printMaxActivitiesPiS_i(i32* %s, i32* %f, i32 %n) #4 {
entry:
  ...
  %call = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str, i64 0, i64 0))
  ...
  %call2 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  %0 = load i32, i32* %i, align 4
  %call3 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* nonnull dereferenceable(8) %call2, i32 %0)
...
for.body:                                         ; preds = %for.cond
  ...
  %6 = load i32*, i32** %f.addr, align 8
  %7 = load i32, i32* %i, align 4
  %idxprom4 = sext i32 %7 to i64
  %arrayidx5 = getelementptr inbounds i32, i32* %6, i64 %idxprom4
  %8 = load i32, i32* %arrayidx5, align 4
  %cmp6 = icmp sge i32 %5, %8
  br i1 %cmp6, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %call7 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  %9 = load i32, i32* %j, align 4
  %call8 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* nonnull dereferenceable(8) %call7, i32 %9)
...
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %0, i8* align 16 bitcast ([6 x i32]* @__const.main.s to i8*), i64 24, i1 false)
  %1 = bitcast [6 x i32]* %f to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %1, i8* align 16 bitcast ([6 x i32]* @__const.main.f to i8*), i64 24, i1 false)
  store i32 6, i32* %n, align 4
  %arraydecay = getelementptr inbounds [6 x i32], [6 x i32]* %s, i64 0, i64 0
  %arraydecay1 = getelementptr inbounds [6 x i32], [6 x i32]* %f, i64 0, i64 0
  %2 = load i32, i32* %n, align 4
  call void @_Z18printMaxActivitiesPiS_i(i32* %arraydecay, i32* %arraydecay1, i32 %2)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_greedy_algo1.cpp() #0 section ".text.startup" {
entry:
